...
function conky_draw_weather()
    ...
    draw_text(cr, city, city_x, 100, city_font, city_size, city_color)
    ...
    draw_text(cr, weather_desc, desc_x, conky_window.height - 60, desc_font, desc_size, desc_color)
    ...
    local label_y_base = conky_window.height - 30
